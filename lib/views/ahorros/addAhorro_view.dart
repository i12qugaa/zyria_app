...
class AddAhorroView extends StatefulWidget {
  ...
  AddAhorroView({required this.categorias, this.day, this.month, this.year, required this.selectedMode});

  @override
  _AddAhorroViewState createState() => _AddAhorroViewState();
}

class _AddAhorroViewState extends State<AddAhorroView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomGradientAppBar(title: 'Añadir ahorro', actions: [ CustomAppBarActions(homeController: homeController) ],),
