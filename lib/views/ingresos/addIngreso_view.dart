...
class AddIngresoView extends StatefulWidget {
  ...
  AddIngresoView({required this.categorias, this.day, this.month, this.year, required this.selectedMode});

  @override
  _AddIngresoViewState createState() => _AddIngresoViewState();
}

class _AddIngresoViewState extends State<AddIngresoView> {
  ...
  Future<void> _onSavePressed() async {
    await _ingresosController.validateAndAddMovimiento(
      context,
...
// Metodo para mostrar el selector de fecha
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomGradientAppBar(title: 'Añadir ingreso', actions: [ CustomAppBarActions(homeController: homeController) ],),
