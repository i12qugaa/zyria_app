...
class CriptomonedasView extends StatefulWidget {
  final double rentabilidadTotal;
  final double totalActual;

  const CriptomonedasView({
    super.key,
    required this.rentabilidadTotal,
    required this.totalActual,
  });
  @override
  State<CriptomonedasView> createState() => _CriptomonedasViewState();
}

class _CriptomonedasViewState extends State<CriptomonedasView> {
  @override
              ...
              SizedBox(
                ...
                child: FutureBuilder<List<Activo>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final criptomonedas = activos
                        .where((a) => a.tipo == TipoActivo.criptomonedas)
                        .toList();

                    return criptomonedas.isEmpty
                        ? const Center(child: Text("Sin datos"))
                        : ListView.builder(
                      itemCount: criptomonedas.length,
                      itemBuilder: (context, index) {
                        final activo = criptomonedas[index];
                        return Card(
                          elevation: 4,
                          ...
                          child: ListTile(
                            ...
                            leading: const Icon(Icons.currency_bitcoin, color: Colors.blue),
                            title: Text(
                              activo.nombre,
                              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600),
                            ),
                            subtitle: Text(
                              "Valor total actual: ${formatoMoneda.format(activo.valorActual * activo.cantidad)}",
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: "Símbolo (eth,ethereum,...)",
                        errorText: errorSimbolo,
                        suffixIcon: IconButton(
                          icon: const Icon(Icons.search),
                          tooltip: "Buscar valor actual",
                          onPressed: () async {
                            final entradaUsuario = simboloCtrl.text.trim();
                            final simbolo = controller.traducirASimboloFinnhub(entradaUsuario);
          ...
          actions: [
            ...
            TextButton(
                ...
                onPressed: () async {
                  ...
                  if (success) {
                    setState(() {}); // <- 🔁 esto es lo importante
                    ScaffoldMessenger.of(context).showSnackBar(
