...
class AccionesEtfsView extends StatefulWidget {
  final double rentabilidadTotal;
  final double totalActual;

  const AccionesEtfsView({
    super.key,
  ...
  @override
  State<AccionesEtfsView> createState() => _AccionesEtfsViewState();
}


class _AccionesEtfsViewState extends State<AccionesEtfsView> {
  @override
              ...
              SizedBox(
                ...
                child: FutureBuilder<List<Activo>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final accionesEtfs = activos
                        .where((a) => a.tipo == TipoActivo.accionesEtfs)
                        .toList();

                    return accionesEtfs.isEmpty
                        ? const Center(child: Text("Sin datos"))
                        : ListView.builder(
                      itemCount: accionesEtfs.length,
                      itemBuilder: (context, index) {
                        final activo = accionesEtfs[index];
                        return Card(
                          elevation: 4,
                  ...
                  child: TextButton.icon(
                    onPressed: () async {
                      ...
                      if (historial.isEmpty) {
                        ...
                        // Luego muestra el SnackBar en el contexto anterior (asegúrate de que siga siendo válido)
